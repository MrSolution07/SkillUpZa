...
const AccountSettingsCard = () => {
  ...
  const fetchUserData = async () => {
    try {
      const response = await axios.post('https://backend-skillup.onrender.com/user/update_user.php', {
  ...
  const handleAccountSettingsSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('https://backend-skillup.onrender.com/user/update_user.php', formData, {
        headers: {
  ...
  try {
    ...
    const response = await axios.post('https://backend-skillup.onrender.com/user/update_user_password.php', {
      username,
      currentPassword,
      newPassword,
    });
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
      try {
        const response = await axios.post('https://backend-skillup.onrender.com/user/delete.php', {
          username: localStorage.getItem('username')
        });
        const data = response.data;
