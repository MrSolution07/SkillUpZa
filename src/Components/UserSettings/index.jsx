...
//   const fetchUserData = async () => {
//     try {
//       const response = await axios.post('http://localhost/DATABASE_DATA/get_user_data.php', {
//         username: localStorage.getItem('username')
//       });
//       const responseData = response.data;
//       if (response.status === 200) {
...
//         setMobileNumber(responseData.mobile_number);
//         setProfilePictureBase64(responseData.profile_picture);
//       } else {
//         console.error('Error:', responseData.message);
//       }
//     } catch (error) {
...
//     event.preventDefault();
//     try {
//       const response = await axios.post('http://localhost/DATABASE_DATA/update_password.php', {
//         username,
//         currentPassword,
//         newPassword
//       });
...
//         window.alert('Error updating password: ' + response.data.message);
//       }
//     } catch (error) {
//       console.error('Error updating password:', error);
//     }
...
//     if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
//       try {
//         const response = await axios.post('http://localhost/DATABASE_DATA/delete_account.php', {
//           username: localStorage.getItem('username')
//         });
//         if (response.data.success) {
//           localStorage.removeItem('username');
...
//           window.location.href = '/'; // Redirect to home page
//         } else {
//           window.alert('Error deleting account: ' + response.data.message);
//         }
//       } catch (error) {
//         console.error('Error deleting account:', error);
//         window.alert('Error deleting account');
...
const AccountSettingsCard = () => {
  ...
  const fetchUserData = async (username) => {
    try {
      const response = await axios.post('http://localhost/DATABASE_DATA/update_details.php', {
        username
      });
      const responseData = response.data;
  ...
  const handleAccountSettingsSubmit = async (event) => {
    ...
    try {
      ...
      if (profilePicture) {
        ...
        const pictureResponse = await axios.post('http://localhost/DATABASE_DATA/upload_picture.php', formData, {
          headers: {
            'Content-Type': 'multipart/form-data'
          }
        });
        ...
        if (pictureData.success) {
          ...
          window.alert('Error uploading profile picture: ' + pictureData.message);
        }
      }
    } catch (error) {
      console.error('Error updating user data:', error);
