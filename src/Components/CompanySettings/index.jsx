...
const AccountSettingsCard = () => {
  ...
  const fetchUserData = async () => {
    try {
      const response = await axios.post('https://backend-skillup.onrender.com/business/bus_update.php', {
  ...
  const handleAccountSettingsSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('https://backend-skillup.onrender.com/business/bus_update.php', formData, {
        headers: {
  ...
  const handlePasswordChangeSubmit = async (event) => {
    event.preventDefault();
    try {
      const response = await axios.post('https://backend-skillup.onrender.com/business/update_bus_password.php', {
        username: localStorage.getItem("companyname"),
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
      try {
        const response = await axios.post('https://backend-skillup.onrender.com/business/bus_delete.php', {
          username: localStorage.getItem('companyname')
        });
        const data = response.data;
        if (data.success) {
