...
const AccountSettingsCard = () => {
  ...
  const fetchUserData = async () => {
    try {
      const response = await axios.post('  http://skill-up-za.infinityfreeapp.com/bus_update.php', {
  ...
  const handleAccountSettingsSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('  http://skill-up-za.infinityfreeapp.com/bus_update.php', formData, {
        headers: {
  ...
  const handleDeleteAccount = async () => {
    if (window.confirm('Are you sure you want to delete your account? This action cannot be undone.')) {
      try {
        const response = await axios.post('  http://skill-up-za.infinityfreeapp.com/bus_delete.php', {
          username: localStorage.getItem('companyname')
        });
        const data = response.data;
