...
const ViewDetails = () => {
    ...
    useEffect(() => {
        ...
        const fetchProfilePicture = async () => {
            try {
                const response = await axios.get('https://skill-up-za-a416b38edeac.herokuapp.com/DATABASE_DATA/getpicture.php', {
                    params: { username }
                });
        ...
        const fetchUserDetails = async () => {
            try {
                const response = await fetch('https://skill-up-za-a416b38edeac.herokuapp.com/DATABASE_DATA/get_user_details.php', {
                    method: 'POST',
                    headers: {
