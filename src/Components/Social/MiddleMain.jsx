...
const MiddleMain = () => {
    ...
    useEffect(() => {
        ...
        const fetchPosts = async () => {
            try {
                const response = await axios.get('  https://cannonball-can.000webhostapp.com/get_posts.php');
                const data = response.data;
                if (data.success) {
                    setPosts(data.posts);
                } else {
    ...
    const handleCreatePost = async () => {
        ...
        try {
            const response = await axios.post('  https://cannonball-can.000webhostapp.com/create_post.php', formData, {
                headers: {
