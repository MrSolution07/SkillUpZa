...
const MiddleMain = () => {
    ...
    useEffect(() => {
        const fetchProfilePicture = async () => {
            try {
                ...
                const response = await axios.get('https://backend-skillup.onrender.com/user/getpicture.php', {
                    params: { username }
                });
        ...
        const fetchPosts = async () => {
            try {
                const response = await axios.get('https://backend-skillup.onrender.com/posts/get_posts.php');
                const data = response.data;
                if (data.success) {
                    setPosts(data.posts);
                } else {
    ...
    const handleCreatePost = async () => {
        ...
        try {
            const response = await axios.post('https://backend-skillup.onrender.com/posts/create_post.php', formData, {
                headers: {
