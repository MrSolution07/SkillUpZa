...
function DashboardPage({ children }) {
  ...
  useEffect(() => {
    ...
    const fetchProfilePicture = async () => {
      try {
        const response = await axios.get('https://backend-skillup.onrender.com/business/get_bus_picture.php', {
          params: { username }
        });
    ...
    const fetchUserDetails = async () => {
      try {
        const response = await fetch('https://backend-skillup.onrender.com/business/get_bus_details.php', {
          method: 'POST',
          headers: {
